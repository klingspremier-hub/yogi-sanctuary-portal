...
const ScheduleSection = () => {
  ...
  const schedule = [{
    time: "07:30",
    activity: "Sunrise Meditation & Pranayama",
    icon: Sunrise,
    all: true
  }, {
    time: "08:30",
    activity: "Vegetarian Breakfast",
    icon: Coffee
  }, {
    time: "09:30",
    ...
    time: "14:00",
    activity: "Self-study & Leisure Time",
    highlight: true,
    icon: Flower2
  }, {
    time: "16:00",
    ...
    time: "18:15",
    activity: "Yin Yoga Asana Practice",
    icon: Flower2,
    all: true
  }, {
    time: "19:45",
    activity: "Vegetarian Dinner",
    icon: Coffee
  }, {
    time: "20:45",
    activity: "Study or Gentle Leisure",
    highlight: true,
    icon: Moon
  }, {
    time: "23:00",
    activity: "Noble Silence",
    icon: Moon
  }];
  const arrivalSchedule = [{
    ...
    time: "20:30",
    activity: "Silent Yin Practice"
  }];
  const saturdaySchedule = [{
    time: "07:30 – 08:15",
    activity: "Sunrise meditation and pranayama",
    icon: Sunrise
  }, {
    time: "08:30 – 09:15",
    activity: "Breakfast",
    ...
    time: "09:30 – 13:00",
    activity: "Final practical exams and TTC closing",
    icon: GraduationCap,
    ttcOnly: true
  }, {
    time: "13:00 – 14:00",
    ...
    time: "14:00 – 19:00",
    activity: "Extended leisure time",
    icon: Flower2,
    highlight: true
  }, {
    time: "19:00 – 20:00",
    activity: "Group closing ceremony and photos",
    icon: Camera
  }, {
    time: "20:00 – 21:30",
  ...
  return <section id="schedule" className="py-24 md:py-40 luxury-gradient-dark texture-overlay relative overflow-hidden">
      {/* Decorative orbs */}
      <div className="glow-orb w-96 h-96 -top-48 -right-48" style={{
      animationDelay: '0s'
    }} />
      <div className="glow-orb w-64 h-64 bottom-0 -left-32" style={{
      animationDelay: '3s'
    }} />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10" ref={ref}>
        ...
        ease: [0.16, 1, 0.3, 1]
          ...
          <div className="yin-card p-8 md:p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {arrivalSchedule.map((item, index) => <motion.div key={index} className="text-center p-4 border border-gold/10 hover:border-gold/30 transition-colors duration-500" initial={{
              opacity: 0,
              y: 10
            }} animate={isInView ? {
              opacity: 1,
        ...
        {/* Training Days Table */}
        <motion.div className="yin-card p-8 md:p-12 mb-16" initial={{
        opacity: 0,
        y: 20
      }} animate={isInView ? {
        opacity: 1,
        ...
        ease: [0.16, 1, 0.3, 1]
          ...
          <div className="space-y-2">
            ...
            return <motion.div key={index} className={`flex items-center gap-6 p-4 transition-all duration-500 hover:bg-gold/5 group ${item.highlight ? "bg-primary-foreground/5 border-l-2 border-gold" : ""}`} initial={{
              opacity: 0,
              x: -20
            }} animate={isInView ? {
              opacity: 1,
              ...
              delay: 0.4 + index * 0.05
                  ...
                  <div className="flex-1">
                    ...
                    {item.subtitle && <span className="block text-xs text-primary-foreground/40 mt-1">
                        {item.subtitle}
                      </span>}
                  </div>
                </motion.div>;
        ...
        {/* Sunday - Departure */}
        <motion.div className="yin-card p-8 md:p-12" initial={{
        opacity: 0,
        y: 20
      }} animate={isInView ? {
        opacity: 1,
        ...
        ease: [0.16, 1, 0.3, 1]
          ...
          <div className="space-y-2">
            ...
            const Icon = item.icon;
            return <motion.div key={index} className="flex items-center gap-6 p-4 transition-all duration-500 hover:bg-gold/5 group" initial={{
              opacity: 0,
              x: -20
            }} animate={isInView ? {
              opacity: 1,
