...
const Footer = () => {
  ...
  return (
    <footer className="luxury-gradient-dark texture-overlay py-24 px-6 relative overflow-hidden" ref={ref}>
      {/* Decorative orbs */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div 
          className="grid grid-cols-1 md:grid-cols-2 gap-12 text-sm font-light text-primary-foreground/60 max-w-2xl mx-auto mb-16" 
        ...
        >
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-end gap-4">
              <a 
                href="https://www.instagram.com/annehathayoga/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-3 border border-gold/20 hover:border-gold hover:bg-gold/10 transition-all duration-300 group"
              >
